  ...
  return (
    <section  data-aos="slide-right" className="py-16 bg-white">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-12">
          <h2 className="text-[24px] text-center  md:text-[40px] font-poppins font-[700] text-[#032A32] mb-4">
            Frequently Asked Questions
          </h2>
          <p className="text-[#000] md:text-center  text-[18px]">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-200 pb-4">
              ...
              >
                <span className="text-[20px] w-[70%] font-[700]">{faq.question}</span>
                <span>
