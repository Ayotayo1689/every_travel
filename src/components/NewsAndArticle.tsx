...
const NewsAndArticle = () => {
  return (
    <div className="  w-full  ">
      <h1 data-aos="fade-down" className="text-center font-poppins font-[700] text-[40px] mb-6 text-[#032A32] ">
        Latest News & Articles
      </h1>
      <div data-aos="flip-down" className="flex gap-10">
        <div className="flex-1 inset-0   min-h-[500px]">
