...
export default function AirportRides() {
    ...
    <div className="space-y-6">
      <div className="flex p-6 bg-white rounded-2xl items-center justify-between">
        <h1 className="text-[20px] font-bold text-gray-900">
          Bookings History - Airport Rides
        </h1>
                  ...
                  <div className="space-y-1  w-full">
                    <div className="flex justify-between items-center gap-2">
                      <h3 className="font-[700] text-[#1D1F1F] text-lg flex items-center gap-2">
                        {" "}
                        <AirportRideIcon /> Airport ride - {booking.hotel}
                      </h3>
                    ...
                    <p className="">
                      {" "}
                      <span className="text-[#5D6465] ">From: </span>{" "}
                      {booking.location}
                    </p>
                    <p className="mb-6">
                      {" "}
                      <span className="text-[#5D6465] ">To: </span>{" "}
                      {booking.location}
                    </p>
